...
INSERT INTO Category VALUES('1','School','F99F53');
INSERT INTO Category VALUES('2','Work','C0BA6E');
INSERT INTO Category VALUES('3','Social','FDD9D5');
INSERT INTO Category VALUES('4','Spiritual','3B695F');
INSERT INTO Category VALUES('5','Physical','00495F');
...
INSERT INTO Goal VALUES('ec1e54ba-4621-48de-a260-9efb30935649','Walk the dog twice a day','','daily',2,'Physical');
INSERT INTO Goal VALUES('3752459d-4a8b-47a0-a4ea-5d9dd85094f0','Go to the gym!','Plan my workouts beforehand','weekly',3,'Physical');
INSERT INTO Goal VALUES('32ecea2f-0f1f-4887-b02c-c1dc34d3d4fe','Read for 30 minutes a day','10 minutes fiction, 10 minutes nonfiction','daily',30,'Intellectual');
INSERT INTO Goal VALUES('34a58bd4-c38e-4c06-80ef-170f1c06a671','Finish homework before Netflix','','daily',1,'School');
INSERT INTO Goal VALUES('a8274dae-c924-4306-b4e6-3ca8d84e3436','Test goal','Hello world','daily',2,'Test');
...
INSERT INTO Task VALUES('A','Module 11 Homework','Fri Apr 19 2024','Details on Canvas',1,'School');
INSERT INTO Task VALUES('B','Module 12 Homework','Sat Apr 20 2024','Details on Canvas',1,'School');
INSERT INTO Task VALUES('C','Finish reports for Q4','Mon Apr 22 2024','Reply to Jenna once finished',1,'Work');
INSERT INTO Task VALUES('49780d2a-b317-4b9c-99e4-7f757177b72f','Grocery shopping','Sat Apr 20 2024',replace('Walmart, Trader Joe''s, Costco\nDon''t forget green beans!','\n',char(10)),1,'Miscellaneous');
INSERT INTO Task VALUES('e9dc5aa6-6fca-4370-9112-591f00f9077b','Read Biology textbook','Tue Apr 23 2024','',0,'School');
INSERT INTO Task VALUES('51fb7119-a883-44ac-9c0f-e90c472da21a','Test task','Fri Apr 12 2024','Hello world',1,'Test');
INSERT INTO Task VALUES('D','Test 1','Tue Apr 23 2024','',1,'Test');
INSERT INTO Task VALUES('2144f82e-5fbf-4056-9507-b1fc2a58bbe5','Completed task','Fri Apr 26 2024','',1,'None');
INSERT INTO Task VALUES('96f05da3-3f02-4a95-a568-8332aff0b9ee','Return library books','Sat Apr 27 2024','',0,'Miscellaneous');
INSERT INTO Task VALUES('48762c6a-3171-44a4-9d29-61023149209c','Trader Joe''s run','Fri Apr 26 2024','',0,'None');
INSERT INTO Task VALUES('db59c943-8a79-4b8d-88f1-b6ea662251ac','Weed the garden','Sat Apr 27 2024','',0,'Housekeeping');
INSERT INTO Task VALUES('9e65cee2-c6d7-4d5c-bda4-2a2d73b71ae8','Practice flute','Tue Apr 30 2024','',0,'Intellectual');
INSERT INTO Task VALUES('db970105-d1b2-4a4c-af34-a5538a026057','Dog park','Mon Apr 29 2024','Meet up with Lexi?',0,'Physical');
CREATE TABLE IF NOT EXISTS User (
username TEXT PRIMARY KEY,
password TEXT NOT NULL
);
INSERT INTO User VALUES('Emily','Test');
